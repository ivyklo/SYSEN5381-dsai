# ACTIVITY_function_calling.py
# Function Calling Activity — multiply_numbers tool
# Pairs with ACTIVITY_function_calling.md
# Updated script from 02_function_calling.py by Tim Fraser

# This script demonstrates how to use function calling with an LLM in Python.
# Students define a function as a tool and execute tool calls from the model response.
